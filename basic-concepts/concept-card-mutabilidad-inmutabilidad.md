## 🧠 TARJETA DE ESTUDIO – MUTABILIDAD vs INMUTABILIDAD
...
Ejemplo conceptual:
👉 crear algo y luego modificarlo.
...
Ejemplo conceptual:
👉 modificar = crear una nueva versión.
...
Modificar objetos compartidos sin darse cuenta:
👉 un cambio afecta a otros lugares del sistema.
